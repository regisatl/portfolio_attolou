            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-end my-2 py-2">
                    <Link :href="route('projects.create')"
                        class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-md shadow-lg">New
                    Project</Link>
                </div>
                <form class="w-full mb-3">
                    <div class="flex">
                        <button id="dropdown-button" data-dropdown-toggle="dropdown"
                            ...
                            type="button">All Projects <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true"
                        ...
                        <div id="dropdown"
                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                                <li v-for="project in projects.data" :key="project.id">
                                    <button type="button"
                                        class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{{ project.name }}</button>
                                </li>
                            </ul>
                        </div>
                        <div class="relative w-full">
                            <input type="search" id="search-dropdown"
                                ...
                                placeholder="Search in projects lists table..." required>
                            <button type="submit"
