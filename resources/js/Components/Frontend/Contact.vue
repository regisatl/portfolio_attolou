                    ...
                    <form class="space-y-8 w-full max-w-md">
                        <div class="flex gap-8">
                            <div>
                                ...
                                <span class="text-sm font-medium m-2 text-red-500">Error</span>
                            </div>
                            <div>
                        ...
                        <textarea id="message" rows="4"
                            ...
                            <button type="button" class="text-gray-100 bg-slate-800 hover:bg-slate-900 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-[#40a4fb] dark:hover:bg-blue-600  dark:border-[#40a4fb] w-full">Send </button>
                    </form>
                </div>
        </div>
    </section>
