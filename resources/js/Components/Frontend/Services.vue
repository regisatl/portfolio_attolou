...
<template>
    <section id="services" class="section bg-gray-100 dark:bg-slate-100 py-8">
        <div class="container mx-auto" v-motion:initial="{opacity:0, y:100,}" :visible="{opacity:1, y:0,}">
            ...
            <div class="grid lg:grid-cols-4 gap-9 py-8 animate-slide-up-image">
                <div
                    ...
                    <div class="text-[#40a4fb] rounded-sm w-12 h-12 flex justify-center items-center mb-24 text-[28px]">
                ...
                <div
                    class="relative isolate overflow-hidden dark:bg-slate-800 p-6 rounded-2xl shadow-2xl transform hover:scale-110 transition duration-500">
                    <svg viewBox="0 0 1024 1024"
                        class="absolute left-1/2 top-1/2 -z-10 h-[64rem] w-[64rem] -translate-y-1/2 [mask-image:radial-gradient(closest-side,white,transparent)] sm:left-full sm:-ml-80 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2 lg:translate-y-0"
                        aria-hidden="true">
                        <circle cx="512" cy="512" r="512" fill="url(#759c1415-0410-454c-8f7c-9a820de03641)"
