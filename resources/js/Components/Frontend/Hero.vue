...
<template>
    <section id="home"
        class="lg:h-[85vh] flex items-center bg-light-secondary dark:bg-primary py-32 lg:py-0 overflow-hidden">
        <div class="container mx-auto h-full">
            <div class="flex flex-col md:flex-row items-center h-full pt-8">
                <div class="flex-1 flex-col items-center lg:items-start">
                    ...
                    <h1
                        class="text-4xl leading-[44px] md:text-5xl md:leading-light lg:text-7xl lg:leading-[1.2] font-bold md:tracking-[-2px] dark:text-gray-100 text-slate-800">
